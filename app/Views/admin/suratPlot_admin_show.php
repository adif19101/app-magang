...
<div class="col-auto">
    <div class="btn-list">
        ...
        <?php elseif ($surat['status'] == 'DONE') : ?>
            <a href="<?= base_url('admin/suratPlot/download/' . $surat['id']) ?>" class="btn btn-success" title="Download" target="_blank" aria-label="Button" data-bs-toggle="tooltip" data-bs-placement="right">
