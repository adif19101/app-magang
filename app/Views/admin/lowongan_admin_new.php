...
<script>
    $(document).ready(function() {
        $('.summernote').summernote({
            ...
            callbacks: {
                onChange: function(contents, $editable) {
                    ...
                    $('#tambah_lowongan_admin').validate().element('.summernote');
                }
            }
        });
        ...
        $("#tambah_lowongan_admin").validate({
            ignore: [],
            rules: {
                judul: {
                    required: true,
        ...
        $('#btn_save').on('click', function() {
            if ($('#tambah_lowongan_admin').valid()) {
                $('#tambah_lowongan_admin').submit();
            }
        });
