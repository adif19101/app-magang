                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3 mb-2">
                            ...
                            <div class="col-md">
                                ...
                                <input id="npm" name="npm" type="text" class="form-control" value="<?= $user['npm'] ?>">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md">
                                <label class="form-label">Tempat, Tanggal Lahir</label>
                                <input type="text" class="form-control" name="tmpt_tgl_lahir" id="tmpt_tgl_lahir"  value="<?= $user['tmpt_tgl_lahir'] ?>" placeholder="Contoh: Karawang, 1 Januari 2018">
                            </div>
                            <div class="col-md">
    ...
    $(document).ready(function() {
        ...
        $("#form_profile").validate({
            ...
            submitHandler: function(form) {
                ...
                form_data.append("group", "mahasiswa");
