...
<div class="page-body">
    <div class="container-xl">
        <form id="edit_lowongan_perusahaan">
                                ...
                                <label class="row">
                                    ...
                                    <span class="col-auto">
                                        <label class="form-check form-check-single form-switch">
                                            <input <?= formChecker($lowongan['daftar_langsung'], 1, 'checked') ?> id="daftar_langsung" name="daftar_langsung" class="form-check-input" type="checkbox" value="1">
                                        </label>
                                    </span>
                                </label>
...
<script>
    $(document).ready(function() {
        ...
        if ($("#edit_lowongan_perusahaan").length > 0) {
            $("#edit_lowongan_perusahaan").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "<?= base_url('perusahaan/lowongan/') . $lowongan['id'] ?>",
                        type: "POST",
                        data: $(form).serialize(),
                        headers: {
        ...
        $('#btn_save').on('click', function() {
            if ($('#edit_lowongan_perusahaan').valid()) {
                $('#edit_lowongan_perusahaan').submit();
            }
        });
    });
</script>
