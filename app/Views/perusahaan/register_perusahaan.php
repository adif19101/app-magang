...
<?= $this->section('main') ?>
    ...
    <div class="container d-flex justify-content-center p-5">
        <div class="card col-12 col-md-5 shadow-sm">
            <div class="card-body">
                <h5 class="card-title mb-5">Register Perusahaan</h5>
                ...
                <form action="<?= url_to('register') ?>" method="post">
                    ...
                    <!-- Nama Perusahaan -->
                    <div class="mb-2">
                        <input type="text" class="form-control" name="nama" inputmode="text" autocomplete="nama" placeholder="Nama Perusahaan" value="<?= old('nama') ?>" required />
                    </div>

                    <!-- Alamat Perusahaan -->
                    <div class="mb-2">
                        <textarea name="alamat" class="form-control" inputmode="text" autocomplete="alamat" placeholder="Alamat Perusahaan" required><?= old('alamat') ?></textarea>
                    </div>
