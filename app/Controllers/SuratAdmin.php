...
class SuratAdmin extends BaseController
{
    ...
    public function dtAction($id, $status)
    {
        ...
        if ($status == 'DONE') {
            $button .= '<a href="' . base_url('admin/surat/download/' . $id) . '" class="btn btn-success btn-icon btn-sm" title="Download" aria-label="Button" data-bs-toggle="tooltip" data-bs-placement="right">
